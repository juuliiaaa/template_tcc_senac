...
\textbf{2.3.7 Redes Neurais Convolucionais (CNN)}
...
\textbf{2.3.8 Redes de Memória de Longo Prazo (LSTM)}
...
Por fim, o tratamento de variações linguísticas resolve questões essenciais de concordância nominal e verbal, além de refinar a estrutura frasal, resultando em uma saída de texto que seja natural e compreensível para o usuário ouvinte \cite{Lopez2017}.
