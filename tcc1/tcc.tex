...
O diferencial da CNN reside nas camadas de convolução, que aplicam filtros matemáticos para extrair características hierárquicas da imagem, como bordas, texturas e, finalmente, o formato específico dos dedos. Esse processo permite que o modelo identifique padrões visuais independentemente de pequenas variações de posição ou iluminação.
