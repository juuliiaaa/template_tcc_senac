...
\textbf{2.3.6 Redes Neurais Convolucionais (CNN)}
...
\textbf{2.3.7 Redes de Memória de Longo Prazo (LSTM)}
...
\textbf{2.3.8 Custo Computacional e Peso dos Modelos}
...
\textbf{2.3.8 Latência e Tempo de Resposta}
